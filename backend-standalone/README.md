...
Headless CMS and API backend for the Astrology App, built with Strapi v5, TypeScript, PostgreSQL, and Firebase Admin SDK.

This repository contains the backend service that powers the Astrology App mobile application.
